...
from sam.smallvggnet import SmallVGGNeT
...
# construct the argument parser and parrse the arguments
ap = argparse.ArgumentParser()
ap.add_argument("-d", "--dataset", required=True,
                help="path to input dataaset of images")
...
# grab the image path and shifflr them
...
H = model.fit_generator(aug.flow(trainX, trainY, batch_size=BS), validation_data=(testX, testY),
                        steps_per_epoch=len(trainY) // BS, epochs=EPOCHS)
...
plt.title("Training Loss and Accuracy (SmallVGNet)")
plt.xlabel("Epoch #")
